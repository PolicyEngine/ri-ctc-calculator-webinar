...
export const agenda: AgendaItem[] = [
  { time: '2:00 PM - 2:45 PM', title: 'Rhode Island Child Tax Credit Calculator Webinar', speakerIds: ['max-ghenis', 'pavel-makarchuk', 'david-trimmer'], slideshowId: 'ri-ctc-webinar-2026', type: 'talk', hasQA: true },
];
